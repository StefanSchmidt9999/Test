...
namespace winrt::SQLOLEDB_Test::implementation
{
    ...
    struct WINRT_IMPL_EMPTY_BASES MainWindow_base : implements<D, SQLOLEDB_Test::MainWindow, composing, I...>,
        ...
        impl::base<D, winrt::Microsoft::UI::Xaml::Window>
    {
        ...
        using class_type = SQLOLEDB_Test::MainWindow;
        ...
        {
            return L"SQLOLEDB_Test.MainWindow";
        }
        MainWindow_base()
        {
...
namespace winrt::SQLOLEDB_Test::factory_implementation
{
    ...
    {
        using instance_type = SQLOLEDB_Test::MainWindow;
