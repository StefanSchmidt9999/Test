...
#endif
#if __has_include(<winrt/SQLOLEDB_Test.h>)
...
using TypeKind = ::winrt::Windows::UI::Xaml::Interop::TypeKind;
    ...
    namespace XamlTypeInfo_staticasserts
    {
        ...
        static_assert( is_type_complete_v<::winrt::SQLOLEDB_Test::MainWindow>, "Please #include the implementation header for '::winrt::SQLOLEDB_Test::MainWindow' in your precompiled header 'pch.h'." );
...
const TypeInfo TypeInfos[] = 
{
    ...
    -1,
    //   3
    L"SQLOLEDB_Test.MainWindow", L"",
    &ActivateLocalType<::winrt::SQLOLEDB_Test::implementation::MainWindow>, nullptr, nullptr, nullptr,
...
{
    //   0 - SQLOLEDB_Test.MainWindow.MyProperty
    L"MyProperty",
    &GetValueTypeMember_MyProperty<::winrt::SQLOLEDB_Test::MainWindow, int32_t>,
    &SetValueTypeMember_MyProperty<::winrt::SQLOLEDB_Test::MainWindow, int32_t>,
    0, // Int32
    -1,
    false, false, false,
